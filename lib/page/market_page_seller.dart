...
class _MarketPageState extends ConsumerState<MarketPageSeller> {
  ...
  List<String> dayMarketPrice = ['1 hr', '3 hr', '7 hr', '14 hr'];
  int dayMarketPriceIsSelected = 0;
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          ...
          children: [
            ...
            const TitleComponent(title: 'Farmer '),
            Stack(children: [
              Container(
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => GestureDetector(
                      onTap: () {
                        setState(() {
                          dayMarketPriceIsSelected = index;
                        });
                      },
                      child: Card(
                        color: (dayMarketPriceIsSelected == index)
                            ? Colors.white
